...
export const SITE = {
  ...
  I18N: {
    ...
    "nav.websites": "Сайти",
    "nav.backend": "Бекенд",
    "page.bots.kicker": "Telegram-боти",
    "page.bots.title": ["Боти, які", "приймають замовлення", "без вас"],
    "page.bots.lead": "Каталог, кошик, оплата карткою, сповіщення власнику і адмінка для товарів. Або розсилки, заявки й модерація чату — залежно від задачі.",
    "page.websites.kicker": "Сайти й застосунки",
    "page.websites.title": ["Сторінка, яка", "перетворює візит", "на заявку"],
    ...
    "nav.websites": "Sites",
    "nav.backend": "Backend",
    "page.bots.kicker": "Telegram bots",
    "page.bots.title": ["Bots that", "take the orders", "without you"],
    "page.bots.lead": "Catalogue, cart, card payments, owner notifications and an admin panel for products. Or broadcasts, leads and chat moderation — whatever the task needs.",
    "page.websites.kicker": "Sites and apps",
    "page.websites.title": ["A page that", "turns a visit", "into a request"],
