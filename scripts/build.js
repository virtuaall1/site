...
/* Адрес сайта — свой домен. Он записан прямо в исходниках, потому
   что сайт там и живёт: canonical, og:url, карта сайта и ссылки на
   кейсы берут его отсюда, и ничего задавать снаружи не нужно.

   SITE_URL по-прежнему перебивает: пригодится для черновой копии на
   другом адресе или при очередном переезде. Внутренние ссылки везде
   относительные, их менять не нужно в любом случае. */
